...
- 결과: evaluation/compare_v5_v6.json
"""
import json
import time
import re
...
V6_DIR        = "output/qwen-coder-finetune-v6"
DATA_PATH     = "data/github_solutions.json"
OUTPUT_PATH   = "evaluation/compare_v5_v6.json"
...
def main():
    ...
    for version, adapter_dir in [("v5", V5_DIR), ("v6", V6_DIR)]:
        ...
        for i, problem in enumerate(problems):
            ...
            if entry is None:
                entry = {"title": title, "level": level, "sig": sig, "v5": {}, "v6": {}}
    ...
    print("\n주의: code_correct 필드는 null로 저장됨. evaluation/compare_v5_v6.json을")
